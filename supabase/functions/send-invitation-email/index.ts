...
Deno.serve(async (req) => {
  ...
  try {
    ...
    const { email, inviterName, role, workspaceName, appUrl: appUrlFromBody } = await req.json();
    ...
    const appUrl = appUrlFromBody || Deno.env.get("APP_URL") || "https://app.studiofab.com";
